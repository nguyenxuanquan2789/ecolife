...
class PosSaleProductsWidget extends WidgetHelper { 
	...
	protected function render() {
		...
		$product_loop_file = _PS_MODULE_DIR_ . 'poselements/views/templates/front/sale-products-loop.tpl';
		$context->smarty->assign(
			array(
		...
		$template_file_name = _PS_MODULE_DIR_ . 'poselements/views/templates/front/sale-products.tpl';
